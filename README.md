# University.KhNURE..Net.Practice-4

## What is the project about?

Repository is for educational purpose - doing practical class' [task №4](Методичні%20вказівки%20до%20ПЗ%204.pdf) on the
discipline *"Programming on the .Net platform"* in
the university "[Kharkiv National University of Radio Electronics][1]".

## What is the purpose of this project?

The **purpose** of the project is ***doing practical task №4*** on the discipline *"Programming on the .Net platform"*.
...
4. Adds this repository to yours with name `origin` (you can change it, if you want):
    ```
   $ git remote add origin git@github.com:StasonMendelso/University.KhNURE..Net.Practice-4.git
   ```
...
Run the application using the [Demo](Practice4/Demo.cs) class, where you can choose the number of task for executing by
calling another
method.
